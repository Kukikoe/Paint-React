...
function ButtonSettings(props) {
    return (
        <div className="dropdown">
            <button className="btn dropbtn dropbtn-settings">
                <svg fill="#FFFFFF"
            ...
            <div className="dropdown-content-settings" id="">
                <span data-id="settings" data-lang="Settings">Settings</span>
                <span data-id="theme" data-lang="Theme">Theme</span>
                <div className="dropdown-content_theme" id="">
                    <span data-id="dark" data-lang="Dark">Dark</span>
                    <span data-id="light" data-lang="Light">Light</span>
                </div>
                <span data-id="lang" data-lang="Lang">Lang</span>
                <div className="dropdown-content_lang" id="">
                    <span data-id="eng" data-lang="Eng">Eng</span>
                    <span data-id="rus" data-lang="Rus">Rus</span>
                </div>
            </div>
        </div>
    )
